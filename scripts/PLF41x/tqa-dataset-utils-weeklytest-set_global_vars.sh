...
export g_store_dir=/mnt/nfs4/DATASETS/PLF/PLF41_WEEKLY/${g_week_label}	# where (in mnt) the datasets are saved
...
export g_scripts_dir=/mnt/nfs4/DATASETS/PLF/PLF41_WEEKLY/scripts/PLF41x

export g_pkg_source=/mnt/nfs4/others/packages/PLF410/plf-enterprise-tomcat-standalone-4.1.0-20130821.050126-141.zip
export g_pkg_commons=/mnt/nfs4/DATASETS/PLF/PLF41_WEEKLY/scripts/PLF41x/commons
