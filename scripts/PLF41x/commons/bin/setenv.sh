...
[ -z $EXO_ASSETS_VERSION ] && EXO_ASSETS_VERSION="4.1.0-SNAPSHOT"
...
CATALINA_OPTS="-XX:+HeapDumpOnOutOfMemoryError -XX:HeapDumpPath=./ -Xms3g -Xmx3g -XX:MaxPermSize=512m -Xss512k -XX:+UseConcMarkSweepGC -XX:+UseCompressedOops -Dcom.sun.management.jmxremote=true -Dcom.sun.management.jmxremote.ssl=false -Dcom.sun.management.jmxremote.port=${TARGET_JMX_PORT} -Dcom.sun.management.jmxremote.authenticate=false ${CATALINA_OPTS} "
