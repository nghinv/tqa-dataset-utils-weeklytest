...
../tqa-dataset-utils-weeklytest-stop-app.sh; ../tqa-dataset-utils-weeklytest-restore.sh ${g_ds_ostd_user_name};
...
../tqa-dataset-utils-weeklytest-backup.sh ${g_ds_user_name};
