...
[ -z $EXO_ASSETS_VERSION ] && EXO_ASSETS_VERSION="4.0.x-SNAPSHOT"
[ -z $EXO_JCR_SESSION_TRACKING ] && EXO_JCR_SESSION_TRACKING=$EXO_DEV
[ -z $EXO_DATA_DIR ] && EXO_DATA_DIR=/java/exo-working/DATASET_WORK/dataset-weekly-plf4/shared/data
...
CATALINA_OPTS="-XX:+HeapDumpOnOutOfMemoryError -XX:HeapDumpPath=./ -Xms3g -Xmx3g -XX:MaxPermSize=512m -Xss512k -XX:+UseConcMarkSweepGC -XX:+UseCompressedOops -Dcom.sun.management.jmxremote=true -Dcom.sun.management.jmxremote.ssl=false -Dcom.sun.management.jmxremote.port=8004 -Dcom.sun.management.jmxremote.authenticate=false ${CATALINA_OPTS} "
...
if [ -d "$JAVA_HOME/jre" ]; then
  # This is a JDK
  CATALINA_OPTS="$CATALINA_OPTS -Djre.lib=\"/srv/jenkins/tools/JDK/Sun_Java_SDK_1.6.0_64bits/jre/lib\""
  CATALINA_OPTS="$CATALINA_OPTS -Djavasrc=\"/srv/jenkins/tools/JDK/Sun_Java_SDK_1.6.0_64bits/src.zip\""
else
  # This is a JRE
  CATALINA_OPTS="$CATALINA_OPTS -Djre.lib=\"/srv/jenkins/tools/JDK/Sun_Java_SDK_1.6.0_64bits/lib\""
